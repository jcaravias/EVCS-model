...
class Model_World(): 
    def __init__(self, no_homes, no_work, no_stores, no_ticks, edge_weight_ranges): 
        ...
        self.edge_weight_ranges = edge_weight_ranges
    ...
    def get_edge_weight(self, node1, node2): 
        ...
        if (type1 == "home" and type2 == "work") or (type2 == "home" and type1 == "work"): 
            ...
            factor = self.edge_weight_ranges["work_to_store"] 
            ...
            factor = self.edge_weight_ranges["store_to_home"] 
